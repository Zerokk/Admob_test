    ...
    function AdMob() {
        ...
        document.addEventListener('deviceready', function () {
            cordova.exec(function (event) {
                ...
                shared_1.fireDocumentEvent(event.type, data);
            }, console.error, 'AdMob', shared_1.NativeActions.ready);
        }, false);
    }
    AdMob.prototype.configure = function (config) {
        return shared_1.execAsync(shared_1.NativeActions.configure, [config]);
    };
    AdMob.prototype.configRequest = function (requestConfig) {
        return shared_1.execAsync(shared_1.NativeActions.configRequest, [requestConfig]);
    };
    AdMob.prototype.setAppMuted = function (value) {
        return shared_1.execAsync(shared_1.NativeActions.setAppMuted, [value]);
    };
    AdMob.prototype.setAppVolume = function (value) {
        return shared_1.execAsync(shared_1.NativeActions.setAppVolume, [value]);
    };
    AdMob.prototype.start = function () {
        return shared_1.execAsync(shared_1.NativeActions.start);
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, shared_1.execAsync(shared_1.NativeActions.requestTrackingAuthorization)];
                    case 1:
                        n = _a.sent();
                        if (n !== false) {
